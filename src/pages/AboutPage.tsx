  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex flex-col gap-4 tracking-tighter leading-7 text-sm font-medium text-slate-800">
        <p>
          Celare es una tienda en línea que se dedica a la venta de celulares,
          fundada en 2021. Nuestro objetivo es ofrecer a nuestros clientes la
          mejor calidad y precio en celulares. Contamos con un equipo de
          profesionales que se encargan de seleccionar los mejores productos
          para ti.
        </p>

        <p>
          En Celare podrás encontrar una amplia variedad de celulares de las
          mejores marcas. Además, contamos con promociones y descuentos
        ...
        <h2 className="text-3xl font-semibold tracking-tighh mt-8 mb-4">
          ¡No esperes más y compra tu celular en Celare!
        </h2>

        <p>
          Para más información, no dudes en ponerte en contacto con nosotros, a
          través de nuestro correo electrónico:
          <a href="mailto:correo@Celare.com">correo@Celare.com</a> o llamado al{" "}
          <a href="tel:333333333">3333333333</a>
        </p>
      </div>
    </div>
  );
