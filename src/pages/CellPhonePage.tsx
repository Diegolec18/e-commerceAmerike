...
export const CellPhonePage = () =>{
    ...
    //Obtener el primer Color predeterminado si ha sido seleccionado
    ...
    //Actualizar almacenamiento seleccionado cuando cambia el color
    useEffect(() => {
    ...
    <div className='h-fit flex flex-col md:flex-row gap-16 mt-8'>
        ...
        <div className='flex-1 space-y-5'>
                    ...
                    onChange={e => setSelectedStorage(e.target.value)}>
                        {
                            colors[selectedColor].storages.map(storage => (
                                <option value={storage} key={storage}>{storage}
                        </option>
                            ))
                        }
                    </select>
            ...
            {/* COMPRAR */}
            {
                isOutOfStock ? (
                    <button
                    className='bg-[#f3f3f3] uppercase font-semibold tracking widest text-xs py-4 rounded full transition-all duration-300
                    hover:bg-[e2e2e2] w-full'
                    disabled
                    >
                        Agotado
                    </button>
                    ...
                    {/* BOTONES ACCIÓN */}
                    <div className="flex flex-col gap-3">
                        <button className='bg-[#f3f3f3] uppercase font-semibold tracking widest text-xs py-4 rounded full transition-all duration-300
                    hover:bg-[e2e2e2]'>
                            Agregar al carrito
                        </button>
